...
from market_regime_analysis.backtester.optimizer import OptimizationResult, StrategyOptimizer
from market_regime_analysis.backtester.strategy import RegimeStrategy
from market_regime_analysis.backtester.walk_forward import WalkForwardValidator
...
class TestAggregateResults:
    ...
    def _make_window_result(self, strategy_return, bh_return, trades=None, test_days=63):
        ...
        from market_regime_analysis.backtester.metrics import PerformanceMetrics
